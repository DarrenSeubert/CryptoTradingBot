...
class Exploration {
    /// <summary>
    /// Unused code found throughout exploration of the Alpaca API.
    /// </summary>
    private void explorationCode() {
        ...
        // IAsset ethAsset = await tClient.GetAssetAsync(SYMBOL); 
        // Console.WriteLine("Get Asset: " + ethAsset + "\n");
    }   
}